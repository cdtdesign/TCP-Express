$(document).ready(function () {
  ...
  $.getScript('http://connect.facebook.net/en_US/sdk.js', function() {
    ...
    return FB.getLoginStatus(function(response) {
      return $('.share-with-facebook').click(function() {
        ...
        header_image = "https://travelingchildrenproject.com/" + $(this).parents('.grid-post').find('.blogImg').attr('src');
  ...
  $('.share-with-twitter').click(function() {
    ...
    var header_image = "https://travelingchildrenproject.com/" + $(this).parents('.grid-post').find('.blogImg').attr('src');
  ...
  $.getScript('//assets.pinterest.com/js/pinit.js', function() {
    $('.share-with-pinterest').click(function() {
      var journey_uuid = "https://travelingchildrenproject.com/blog#" +  $(this).parents('.grid-post').data('journey-uuid');
      var header_image = "https://travelingchildrenproject.com/" + $(this).parents('.grid-post').find('.blogImg').attr('src');
      var title = $(this).parents('.grid-post').children('.blogTitle').text();
      var tags = $(this).parents('.grid-post').find('.blogHash').text();
  ...
  return $('.share-with-tumblr').click(function() {
    ...
    postLink += '&';
    postLink += 'cononicalUrl=' + encodeURIComponent('https://travelingchildrenproject.com/journeyblog');
    postLink += '&';
